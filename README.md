...
GitHub profile: https://github.com/AoojunHappyman (provided by the owner). The LinkedIn URL, a public Expense Tracker demo, and its repository URL are still needed. Visible pending labels deliberately replace generic homepages and localhost links. No graduation date, responsibilities, statistics, or additional experience were invented.
...
Before public release, supply the missing profile and project links. Add absolute Open Graph image and canonical URLs when the final hosting address is known. No deployment was performed.
